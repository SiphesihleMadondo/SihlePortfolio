...
export class ProjectsService {
  ...
  projects: Project [] = [
    ...
    {id: 4, name: 'Sample Wep API, Angular App',pictures: ["../../assets/Angular App, Web API/Image 1.PNG", "../../assets/Angular App, Web API/Image 2.PNG","../../assets/Angular App, Web API/Image 3.PNG"], summary: 'Simple Web API app',description: 'Simple app',projectLink: 'https://github.com/',tags: [Tag.ANGULAR, Tag.TYPESCRIPT, Tag.ASPNETCORE]},
